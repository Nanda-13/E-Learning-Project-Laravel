    ...
    <div class="app-hero-header">
        ...
        <h3 class="fw-light mb-5">
            <a href="{{ route('admin#home') }}" class=" text-dark text-decoration-none">Home</a> / <a href="{{ route('admin#lesson#blog#list') }}"
                class=" text-dark text-decoration-none">Lesson Blog List</a> / <span class="text-primary">Lesson Blog Detail</span>
        </h3>
    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="card shadow mb-4">
                                                <div class="card-header d-flex justify-content-between">
                                                    <h3 class="card-title fs-4 fw-semibold">Lesson Blog Detail</h3>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" value="{{ $lessonBlogDetail->category_name }}" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="mb-3">
                                                                        <label for="" class="form-label">Sub
                                                                            Category Name</label>
                                                                            <input type="text" class="form-control" value="{{ $lessonBlogDetail->sub_category_name }}" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="mb-3">
                                                                        <label for="" class="form-label">Lesson
                                                                            Name</label>
                                                                        <input type="text" class="form-control" value="{{ $lessonBlogDetail->lesson_title }}" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" value="{{ $lessonBlogDetail->blog_status}}" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="mb-3">
                                                                        <label for="" class="form-label">Blog
                                                                            Title</label>
                                                                        <input type="text" class="form-control" value="{{ $lessonBlogDetail->blog_title}}" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="mb-3">
                                                                        <label for="" class="form-label">Lesson Blog
                                                                            Description</label>
                                                                        <textarea name="blogDescription" class="form-control" cols="30" rows="10" readonly>{{ $lessonBlogDetail->blog_description }}</textarea>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <img src="{{ asset( $lessonBlogDetail->blog_image == null ? 'MasterImage/default_Image.jpg' : 'LessonBlogImage/' . $lessonBlogDetail->blog_image ) }}" class=" img-thumbnail w-100" style="height: 300px;" id="output">
                                                                    </div>
                                                                </div>

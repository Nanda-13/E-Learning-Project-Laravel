    ...
    <div class="app-hero-header">
        ...
        <h3 class="fw-light mb-5">
            <a href="{{ route('admin#home') }}" class=" text-dark text-decoration-none">Home</a> / <span
                class=" text-dark text-decoration-none">Lesson Blog</span> / <span class="text-primary">Lesson Blog Create</span>
        </h3>
    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="card shadow mb-4">
                                                <div class="card-header d-flex justify-content-between">
                                                    <h3 class="card-title fs-4 fw-semibold">Lesson Blog Create</h3>
                                                    <a href="{{ route('admin#lesson#blog#list') }}" class=" btn btn-secondary"><i
                                                            class="bi bi-list-task"></i> Lesson Blog List</a>
                                                </div>
                                                <form action="{{ route('admin#lesson#blog#create') }}" method="POST"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" name="status" value="{{ old('status') }}" class="form-control @error('status') is-invalid @enderror" placeholder="Enter Lesson Blog Status...">
                                                                            @error('status')
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="mb-3">
                                                                            <label for="" class="form-label">Lesson Blog
                                                                                Description</label>
                                                                            <textarea name="blogDescription" class="form-control @error('blogDescription') is-invalid @enderror" cols="30" rows="10">{{ old('blogDescription') }}</textarea>
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <img src="{{ asset('MasterImage/default_Image.jpg') }}" class=" img-thumbnail w-100" style="height: 300px;" id="output">

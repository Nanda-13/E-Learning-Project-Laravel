                            ...
                            <table class="table table-bordered align-middle m-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-row align-items-center">
                                                <img src="{{ asset('admin/images/mobiles/mob3.jpg') }}"
                                                    class="img-4x rounded-3 h-auto" alt="Google Admin" />
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-row align-items-center">
                                                <img src="{{ asset('admin/images/mobiles/mob2.jpg') }}"
                                                    class="img-4x rounded-3 h-auto" alt="Bootstrap Gallery" />
                                                <div class="d-flex flex-column ms-3">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-row align-items-center">
                                                <img src="{{ asset('admin/images/mobiles/mob1.jpg') }}"
                                                    class="img-4x rounded-3 h-auto" alt="Bootstrap Gallery" />
                                                <div class="d-flex flex-column ms-3">
                                        ...
                                        <td>
                                            <span class="badge bg-primary"><i
                                                    class="bi bi-caret-down-fill"></i>4.1x</span>
                                        </td>
                                        <td>
                                            <div class="d-flex gap-1">
                    ...
                    <div class="card-body">
                        <div class="scroll350 my-4">
                            <div class="d-flex position-relative">
                                <img src="{{ asset('admin/images/user.png') }}" class="img-4x me-3 rounded-4"
                                    alt="Admin Dashboard" />
                                <div class="mb-5">
